...
# Portfolio 2: Document Formatting
create_portfolio_image(
    title="Document Formatting Sample",
    subtitle="Professional Business Report Formatting",
    content_items=[
        ("BEFORE", "Unformatted text with inconsistent headers, no tables, poor spacing"),
        ("AFTER", "Professional report with styled headers, formatted tables, proper margins"),
    ],
    stats=[("15", "Pages"), ("8", "Tables"), ("12", "Headers"), ("100%", "Consistent")],
    services=["Word Formatting", "Table Design", "Header Styling", "Page Layout", "PDF Export", "Style Guides"],
    filename="portfolio_formatting.png"
)

# Portfolio 3: Proofreading Sample
create_portfolio_image(
    title="Proofreading Sample",
    subtitle="Error Identification and Correction",
    content_items=[
        ("ERRORS FOUND", "48 grammar errors, 12 spelling mistakes, 8 punctuation issues"),
        ("CORRECTIONS", "All errors corrected with explanations and style improvements"),
    ],
    stats=[("68", "Total Errors"), ("100%", "Fixed"), ("24hr", "Turnaround"), ("5*", "Quality")],
    services=["Grammar Check", "Spelling", "Punctuation", "Style Review", "Academic Tone", "Clarity"],
    filename="portfolio_proofreading.png"
)

# Portfolio 4: Teaching Materials
create_portfolio_image(
    title="English Teaching Materials",
    subtitle="Grammar Exercises and Lesson Plans",
    content_items=[
        ("GRAMMAR ENGINE", "34 grammar topics, 4 levels, automated exercise generation"),
        ("EXERCISE TYPES", "Fill-in-blank, MCQ, sentence building, error correction"),
    ],
    stats=[("34", "Topics"), ("4", "Levels"), ("100+", "Exercises"), ("17", "Components")],
    services=["Grammar Instruction", "Exercise Design", "Curriculum Planning", "Student Assessment", "Lesson Plans", "ESL Teaching"],
    filename="portfolio_teaching.png"
)
