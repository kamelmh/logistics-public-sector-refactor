...
| `05_Sources_VBA/` | Code source VBA (37 modules) — الكود المصدري |
...
| Fichier | Description |
|---------|-------------|
| `Memoire_DSS_Logistique_ElBayadh.pdf` | **Version finale** — Thèse complète (Vérifiée 25/25) |
| `Memoire_DSS_Logistique_ElBayadh.docx` | Version DOCX modifiable (TOC auto-généré) |

## 04_Systeme_Academix_v13_2/
| Fichier | Description |
|---------|-------------|
| `ERP_v13.2.xlsm` | **Fichier principal** — 26 feuilles, 37 modules VBA |
...
> **Note:** Les fichiers source VBA dans `05_Sources_VBA/` et `06_Source_Code/VBA_Modules/` sont automatiquement synchronisés depuis `Software_Surgical_Edit/VBA_Modules/` (source canonique). Toute modification doit être faite dans la source canonique.
...
- **Modules VBA:** 37 (importés, 0 erreur de compilation)
