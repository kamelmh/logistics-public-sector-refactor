...
.PARAMETER WorkbookPath
    Path to the workbook for verify/test-macros/dss-audit. Default: ERP_v13.4.xlsm
...
if (-not $WorkbookPath) {
    $WorkbookPath = "$ProjectRoot\ERP_v13.4.xlsm"
}
...
$report = [PSCustomObject]@{
    Pipeline = "Academix v13.4 — Full Pipeline"
