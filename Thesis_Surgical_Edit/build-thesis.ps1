...
Write-Host "[4/10] Formatting cover page..." -ForegroundColor Yellow
try {
...
# Step 4.875: Add page numbering (section breaks + Abjad/Arabic + footers)
Write-Host "[4.875/10] Adding page numbering..." -ForegroundColor Yellow
try {
...
try {
    ...
    # Update all fields (TOC, LOT, page numbers)
