...
| **الفرضية الثانية** | نظام Mini ERP (Excel/VBA) يُحسِّن دقة التتبع ويُقلِّص وقت معالجة الطلبيات | تخفيض وقت التسجيل بأكثر من 97%، وتقليص مدة الجرد بأكثر من 60%، وإلغاء 6 تنبيهات خاطئة من 7 بعد تصحيح ROP الفردي | **✓ مُثبَتة** |
