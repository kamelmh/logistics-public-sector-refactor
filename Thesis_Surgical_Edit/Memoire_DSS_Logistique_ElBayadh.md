...
مؤسسة التكوين المهني بن سعيدي عبد العاطي
بالبيض

**نظام دعم القرار لتسيير المخزونات**
مذكرة تخرج لنيل شهادة التقني السامي
في تسيير المخزونات واللوجستيك

تحت إشراف الأستاذة المشرفة:
**دهيني ميمونة**
...
| --- | --- | --- |
| الطلب السنوي (D) | 33 وحدة | جرد فعلي + إسقاط سنوي (5 OUT × 250/38) [^fn13] |
...
ينتقل هذا المبحث من الإطار الوصفي والمؤسسي إلى التشخيص الكمي للواقع الميداني. يهدف هذا المبحث إلى تحويل الملاحظات النوعية إلى أرقام دقيقة، ومقارنة الأداء الحالي (اليدوي) بالأداء المستهدف (الرقمي)، وصولاً إلى تحديد "الفجوة التشغيلية" التي يسعى نظام دعم القرار v13.4 إلى ردمها.
...
**يقوم نظام دعم القرار v13.4 على مبدأ "التكامل الوظيفي" (Functional Integration)، حيث يتم تحويل أوراق العمل من "جزر معزولة" إلى "وحدات مترابطة" تعمل ككيان واحد. يتم تحقيق هذا التكامل عبر مسارين:**
...
**يتميز نظام دعم القرار v13.4 بمجموعة من الإضافات التي ترفعه من مستوى "جدول بيانات" إلى "نظام خبير":**
...
| سرعة اكتشاف النفاد | عند حدوثه فقط | قبل أسبوع من حدوثه | استباقية 100% |
...
المصدر: إعداد الطالب --- ملاحظة ميدانية مباشرة + قياسات نظام ERP_Académie_v13.4 | فيفري--مارس 2026
...
| *المصدر: إعداد الطالب --- تحليل بيانات ERP_Académie_v13.4 | مارس 2026* |  |  |

: نتائج التحقق من فرضيتَي البحث --- الدليل الميداني {#tbl:04}

### 3. التحقق التجريبي والمصداقية
...
| --- | --- | --- | --- | --- |
| 01 | اعتماد ملف مصلحة المخازن + ERP_Académie_v13.4 رسمياً | المدير | فوري (عند الموافقة) | يومان تدريب كافيان |
...
**ملخص النتائج:** انطلقت الدراسة من تشخيص ميداني دقيق لمخزن مديرية التربية لولاية البيض، ورصدت خمس نقاط ضعف هيكلية تتمحور جميعها حول غياب الأتمتة: لا تنبيه عند الاقتراب من نقطة إعادة الطلب، ازدواجية التسجيل بين الورق والـ Excel، إطالة مدة الجرد، غياب التتبع التاريخي، وانعدام تقييم الموردين. طُبِّقت على البيانات الفعلية ثلاثة أدوات كمية: تحليل ABC، نموذج ويلسون، والمتوسط المرجح — وأنتجت جميعها معطيات تشغيلية مباشرة موثَّقة في الجداول من 01 إلى 06.

**الحلول والنتائج:** أما الحل المقترح، فهو نظام ERP_Académie_v13.4 المبني بـ Excel/VBA، مُضمِّناً ثلاثة إبداعات رئيسية: ROP فردي لكل مادة يُلغي التنبيهات الكاذبة، وطلب سنوي D مُحسَب تلقائياً من البيانات الفعلية، وCMUP ديناميكي يستوعب تقلُّبات الأسعار. ويتميز النظام بتوافقه الكامل مع الإطار التنظيمي الجزائري، بما في ذلك تطبيق الإعفاء من TVA وفق التعليمة 09-2018. أثبتت مؤشرات الأداء أن النظام خفَّض وقت معالجة الطلبية بأكثر من 99.7%، وأطلق التنبيه المُسبَق قبل النفاد، وقلَّص مدة الجرد الفصلي بأكثر من 60%.

**الفرضيات:** وبهذا تُثبَت الفرضيتان المُصاغتان في مقدمة البحث:
- **الفرضية الأولى مُثبَتة:** غياب آليات التنبيه الآلي هو السبب الجذري لتكرار نفاد المواد الاستراتيجية.
- **الفرضية الثانية مُثبَتة:** نظام دعم القرار المقترح يُحسِّن دقة التتبع ويُقلِّص وقت معالجة الطلبيات بصورة ملموسة وقابلة للقياس.

**الحدود:** تبقى هذه الدراسة لها几个 حدود معترف بها: أولاً، اقتصرت على مخزن مديرية التربية لولاية البيض فقط، وقد لا تنطبق النتائج بنفس الدقة على مؤسسات أخرى بمقاييس مختلفة. ثانياً، مدة الرصد الميداني 38 يوماً فقط، وهي كافية للقطع سريعة الدوران لكنها قصيرة للقطع منخفضة التردد. ثالثاً، النظام يعمل على Excel 2010 وهو حل انتقالي — المؤسسات التي تتوفر على إمكانيات أكبر قد تستفيد من نظام قواعد بيانات متكامل.

**الآفاق:** تفتح نتائج هذه الدراسة آفاقاً بحثية عدة: تعميم التجربة على مديريات التربية في الولايات المجاورة، ربط النظام بمنصة استدعاء إلكتروني للتخلص من الورقية، وإجراء دراسات مقارنة بين المؤسسات التي اعتمدت الرقمنة وتلك التي تعتمد الأنظمة اليدوية.

**الرسالة:** تبقى هذه الدراسة حلقةً في مسيرة التحوُّل الرقمي للإدارة الجزائرية. إن التحدي الأكبر لم يكن التقنية — إذ أثبتت التجربة أن Excel/VBA كافٍ — بل كان في إقناع الفاعلين الإداريين بأن الرقمنة ليست ترفاً، بل ضرورة تشغيلية تُوفِّر الوقت والمال وتمنع الاختلالات التي تُعطِّل العملية التربوية في أوقات الذروة. وهذا ما تطمح إليه هذه المذكرة: أن تكون بذرةً لثقافة إدارية رقمية في مؤسسات التربية بولاية البيض وما جاورها.
...
- **Kamel, M. (2026). ERP_Académie v13.4 --- Système d'Aide à la Décision pour la Gestion des Stocks. GitHub. https://github.com/kamelmh/lsm-vba-core.**
...
: الوحدات البرمجية الرئيسية لنظام دعم القرار {#tbl:annex2}
...
: بيانات المخزون الفعلية للأصناف الاثني عشر {#tbl:annex3}
...
: استخدام النماذج اللغوية الكبيرة في التطوير {#tbl:annex5}
...
: ربط المنهاج الرسمي (TAG1801) بنظام دعم القرار {#tbl:annex6a}
...
: التوافق مع الإطار القانوني والتنظيمي الجزائري {#tbl:annex6b}
...
: ربط المفاهيم الأكاديمية بالوحدات البرمجية {#tbl:annex6c}
...
: التحقق الميداني من الفرضيات الأكاديمية {#tbl:annex6d}
...
[^fn3]: D. M. Lambert & J. R. Stock, Strategic Logistics Management, 3rd ed., Irwin, 1993, p. 412.
[^fn4]: J. R. Stock & D. M. Lambert، المرجع السابق، ص. 421.
[^fn5]: الجمهورية الجزائرية الديمقراطية الشعبية، المرسوم الرئاسي رقم 15-247 المؤرخ في 16 سبتمبر 2015 المتعلق بتنظيم الصفقات العمومية وتسييرها، الجريدة الرسمية، العدد 50، 2015.
[^fn6]: المديرية العامة للضرائب، التعليمة رقم 09-2018 المتعلقة بالإعفاء من الرسم على القيمة المضافة لمؤسسات التربية الوطنية، وزارة المالية، الجزائر، 2018.
[^fn7]: A. J. Van Weele, Purchasing and Supply Chain Management, 5th ed., Cengage Learning, 2010, p. 8.
[^fn8]: M. E. A. Belhadi, Modélisation et optimisation de la gestion de stocks des pièces de rechange : application SASACE-Algérie, Mémoire PFE, École Nationale Polytechnique d'Alger, 2015, p. 34.
...
[^fn34]: Microsoft Corporation, VBA Reference — Visual Basic for Applications, Microsoft Docs, 2023.
[^fn35]: Microsoft Corporation, Excel Object Model Overview, Microsoft Docs, 2019.
[^fn36]: Kamel, M, ERP_Académie v13.4 — Système d'Aide à la Décision pour la Gestion des Stocks. GitHub. https://github.com/kamelmh/lsm-vba-core 2026
[^fn39]: المنهاج الدراسي BTS GSL (TAG1801) — المقاييس الـ31 المُغطَّاة في هذه المذكرة: 17. وزارة التربية الوطنية، الديوان الوطني للامتحانات والمسابقات. 18. تحديد وجمع المعلومات الداخلية والخارجية. 19. دراسة الأسعار وشروط التفاوض. 20. القانون الاجتماعي. 21. الإعلام الآلي. ... و26 مقاييس أخرى (المرجع الكامل في قائمة المراجع)