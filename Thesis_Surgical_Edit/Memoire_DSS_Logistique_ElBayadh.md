...
تخضع عمليات التموين والمشتريات في القطاع العام الجزائري لإطار قانوني وتنظيمي صارم يهدف إلى ضمان الشفافية، والمنافسة النزيهة، وحماية المال العام، والمساءلة المالية. ويُعد **المرسوم الرئاسي رقم 15-247 المؤرخ في 16 سبتمبر 2015** المتعلق بتنظيم الصفقات العمومية وتسييرها المرجع الأساسي المنظّم لهذا المجال[^decree15_ch2]، إلى جانب التعليمات الوزارية المشتركة بين وزارة المالية ووزارة التربية الوطنية التي تُحدّد الإجراءات التفصيلية الخاصة بقطاع التربية.
...
من المهم الإشارة إلى أن نسب الفئات ليست ثابتة رياضياً بل تختلف من مؤسسة إلى أخرى حسب طبيعة المخزون ودرجة التشتت بين الأصناف. في مؤسسات القطاع العام الجزائرية، غالباً ما تتجه نسبة الأصناف من الفئة A نحو الانخفاض (10-15%) نظراً لكثرة الأصناف منخفضة القيمة (القرطاسية، الأدوات المكتبية البسيطة) التي تندرج ضمن الفئة C. وقد أكد هذا الاتجاه في السياق الصناعي الجزائري دراسة Belhadi حول نمذجة وتحسين تسيير مخزون قطع الغيار في شركة SASACE-Algérie[^belhadi_ch1].
### ثانياً: نموذج ويلسون للكمية الاقتصادية للطلب
طوّر العالم فرانك ويلسون (Harris, 1913; Wilson, 1934) النموذج الأكثر شهرة في إدارة المخزونات، والذي يُعرف بنموذج الكمية الاقتصادية للطلب. يُعدّ هذا النموذج حجر الزاوية في أسس إدارة المخزون الحديثة[^silver_ch1]. يهدف النموذج إلى تحديد الكمية المثلى للطلب التي تُقلّص مجموع تكاليف الطلب وتكاليف الاحتفاظ بالمخزون إلى حدها الأدنى، مع افتراض طلب ثابت ومُستقر على مدار السنة.
...
بفرض الطلب السنوي D = 789 وحدة (Toner G030 - ART-001)، وتكلفة الطلب S = 801.45 دج (مُستخرجة من تحليل التكاليف الفعلية في الميدان)، وسعر الوحدة PU = 4,500 دج، ومعدل الاحتفاظ I = 20%:
$$Q^* = \sqrt{\frac{2 \times 789 \times 801.45}{0.20 \times 4500}} = \sqrt{\frac{1,264,688.1}{900}} = \sqrt{1,405.21} \approx 37\ \text{وحدة}$$
تكون التكلفة الإجمالية الدنيا عند هذه الكمية:
$$TC(37) = \frac{789}{37} \times 801.45 + \frac{37}{2} \times 0.20 \times 4500 = 17,089 + 16,650 = 33,739\ \text{دج}$$
نلاحظ أن التكلفة الإجمالية تتوزع بشكل متقارب بين تكاليف الطلب (17,089 دج) وتكاليف الاحتفاظ (16,650 دج)، وهذه سمة الرياضيات المثلى: عند Q* يتساوى حدّا التكلفة تقريباً.
**العدد الأمثل للطلبيات سنوياً:**
$$N = \frac{D}{Q^*} = \frac{789}{37} \approx 21\ \text{طلبية/سنة}$$
وهذا يعني أنه يجب تقديم طلبية واحدة كل 250/21 ≈ 12 يوم عمل، وهو تردد يعكس ارتفاع قيمة الوحدة والحاجة إلى تموين منتظم.
...
بفرض استهلاك يومي قدره **3.156** وحدة (= D/250 = 789/250)، وأجل تسليم (LT) قدره **2** يوم، ومخزون أمان (SS) قدره **200** وحدة:
**ROP = (3.156 × 2) + 200 = 206.3 وحدة ≈ 206 وحدة**
...
تُمثل الأنظمة المندمجة الجيل الحديث من البرمجيات الإدارية[^vollmann_ch1]، وهي عبارة عن حزمة متكاملة من التطبيقات التي تهدف إلى إدارة كافة وظائف المؤسسة (المالية، الموارد البشرية، المشتريات، المخزون، الإنتاج) عبر قاعدة بيانات موحدة.
...
| :--- | :---: | :--- |
| الطلب السنوي (D) | **789** وحدة | جرد فعلي + إسقاط سنوي[^d789_method] |
...
$$Q^* = \sqrt{\frac{2 \times 789 \times 801.45}{0.20 \times 4{,}500}} = \sqrt{\frac{1{,}264{,}688.1}{900}} = \sqrt{1{,}405.21} \approx \mathbf{37}\ \text{وحدة}$$

#### ثالثاً: التحقق من التوازن الرياضي المثالي

التكلفة الإجمالية عند الكمية المثلى Q* = 37:

$$TC(37) = \frac{789}{37} \times 801.45 + \frac{37}{2} \times 0.20 \times 4{,}500 = 17{,}089 + 16{,}650 = \mathbf{33{,}739}\ \text{دج}$$

لاحظ أن حد الإصدار (17,089 دج) وحد الاحتفاظ (16,650 دج) متقاربان عند Q*، مما يؤكد خاصية التوازن الرياضي. يعني هذا المستوى **21 طلبية سنوية**، أي طلبية واحدة كل 12 يوم عمل تقريباً، وهو تردد يتناسب مع ارتفاع سعر الوحدة والحاجة إلى تموين منتظم.

#### رابعاً: نقطة إعادة الطلب ومخزون الأمان

لا يكتمل النموذج دون تحديد المستوى الحرج للمخزون الذي عنده تُصدَر الطلبية التالية:

$$ROP = \left(\frac{D}{250}\right) \times LT + SS = \left(\frac{789}{250}\right) \times 2 + 200 = 6.3 + 200 = \mathbf{206}\ \text{وحدة}$$
...
#### ملاحظة حول منهجية تقدير الطلب السنوي (D=789)

تم تقدير الطلب السنوي D=789 وحدة بناءً على منهجية ميدانية صارمة:

1. **جمع البيانات:** ملاحظة مباشرة لـ 38 يوم عمل في مصلحة المخازن (فبراير–مارس 2026)، حيث تم تسجيل جميع حركات الخروج (OUT) للصنف ART-001 (حبر الطابعة Toner G030).
2. **حساب المعدل اليومي:** مجموع الخروج خلال 38 يوم ÷ 38 = المعدل اليومي.
3. **الإسقاط السنوي:** المعدل اليومي × 250 (عدد أيام العمل السنوي) = الطلب السنوي.

**الفرق بين الملاحظة الميدانية والتصنيف التلقائي في النظام:**

| الجانب | الملاحظة الميدانية (D=789) | النظام (ERP) |
| :--- | :--- | :--- |
| **المصدر** | تسجيل يدوي مباشر خلال 38 يوم | حركات MOUVEMENTS المسجلة آلياً |
| **الفترة** | 38 يوم (فبراير–مارس 2026) | جميع الحركات المسجلة في النظام |
| **الإسقاط** | × 250/38 (تحويل يدوي) | حساب تلقائي سنوي |
| **الدقة** | تمثيل واقعي للظروف الحالية | يتكيف مع تغيرات الطلب |
| **الاستخدام** | مدخل أولي لنموذج ويلسون | تحديث مستمر للمعاملات |

تُبرر هذه المنهجية من عدة زوايا:
- **العمليات:** الظروف التشغيلية للمديرية مستقرة نسبياً (لا توجد تغيرات موسمية كبيرة في استهلاك الحبر).
- **التوثيق:** السجلات الورقية المؤرشفة تؤكد استمرارية أنماط الاستهلاك.
- **التوافق:** القيمة المحسوبة (789) تتوافق مع تقديرات مصلحة الميزانية السنوية.

أما النظام (ERP) فيقوم بتحديث الطلب السنوي تلقائياً بناءً على جميع الحركات المسجلة في سجل MOUVEMENTS، مما يضمن تكيف المعادلة مع أي تغير في أنماط الطلب على مدار السنة.
...
- **المهمة الثالثة (الدعم المادي واللوجيستي):** توفير الوسائل المادية والبيداغوجية الكاملة لكافة المؤسسات التعليمية. وتخضع المديرية في تسييرها المالي والميزانياتي لأحكام المرسوم التنفيذي 20-270 المتعلق بتنظيم الميزانية والمحاسبة العمومية[^decree20_ch2].
...
- **التجهيزات الدائمة (Fixed Assets):** وتشمل الحواسيب والطابعات والمعدات المكتبية والأثاث المدرسي. تخضع هذه الفئة لبروتوكول جرد مستقل وفق التعليمات التنظيمية الصادرة عن وزارة التربية الوطنية والمنشور الوزاري المشترك المتعلق بتسيير المستودعات في المؤسسات التربوية[^circular23_ch2].
...
يُشار إلى أن عدة دراسات جزائرية سابقة تناولت هذا الإشكال، منها أعمال Sebti حول أدوات دعم القرار لتسيير المخزون[^sebti_ch3]، وYahi حول برمجيات تسيير مخزون قطع الغيار[^yahi_ch3]، وبشكل أحدث Bouchahlata الذي جمع بين بيئة VBA وذكاء الأعمال في سياق Ericsson Algérie[^bouchahlata_ch3].
...
يُستند في تطوير هذا المحرك إلى مرجعية Microsoft الرسمية لـ VBA[^msft_vba_ch3] ونموذج كائنات Excel[^msft_excel_ch3].
...
- **خوارزمية CMUP:** عند كل عملية دخول جديدة، يقوم المحرك بتحديث التكلفة الوحدوية وفق المعادلة: $CMUP_{new} = \frac{(Stock_{old} \cdot CMUP_{old}) + (Qty_{in} \cdot Price_{in})}{Stock_{old} + Qty_{in}}$. (تُنفَّذ هذه المعادلة في النظام بصيغتها التراكمية المكافئة: CMUP = ΣValeur_IN / ΣQté_IN)
...
#### ثالثاً: أعمدة الذكاء الأربعة في الإصدار v13.3

في الإصدار v13.3، تم تعزيز النظام بأربعة أعمدة ذكائية (DSS Intelligence Pillars) تهدف إلى تحسين قابلية الاستخدام التشغيلية دون زيادة التعقيد أو الاعتماد على مكتبات خارجية. صُمِّمت هذه الأعمدة استجابة للملاحظات الميدانية التي رُصدت خلال مرحلة التجريب، وتُمثِّل انتقالاً من "النظام الحسابي" إلى "النظام الذكي":

**العمود الأول: هندسة الطباعة (Print Engineering)**
تم إعداد نظام طباعة احترافي لجميع أوراق العمل الست والعشرين، يشمل ترويسات تتضمن عنوان النظام والتاريخ وشعار مديرية التربية، وتذييلات تعرض رقم الصفحة الحالي من إجمالي الصفحات، وعناوين مكررة تظهر في كل صفحة (الصفوف الخمس الأولى)، ومناطق طباعة ديناميكية تحسب تلقائياً نطاق البيانات الفعلي في كل ورقة. كما يتم ضبط الهوامش (0.5 بوصة جانباً، 0.75 بوصة أعلى وأسفل) واتجاه الصفحة (أفقي للوحة القيادة، عمودي للإيصالات) وفقاً لطبيعة كل ورقة عمل. هذا الإعداد يضمن أن كل ورقة عمل جاهزة للطباعة مباشرة دون تعديل يدوي.

**العمود الثاني: تحسين تجربة المستخدم (UX Optimization)**
تم تنفيذ ثلاث تحسينات دقيقة في واجهة إدخال الحركات:
- *(أ)* إخفاء زر "المرجع التلقائي" العشوائي الذي كان يُثقل الواجهة، إذ أصبح المرجع يولَّد تلقائياً عند تغيير نوع الوثيقة.
- *(ب)* تشفير حقل سعر الوحدةecimal masking) بزرين عشريين فقط مع تغذية راجعة بصرية: اللون الأخضر عند الإدخال الصحيح، والأصفر عند الحاجة إلى التصحيح.
- *(ج)* التصنيف التلقائي عند اختيار الصنف: يقوم النظام بتحديد فئة الصنف تلقائياً من بيانات الجدول المرجعي، مما يقلل عدد النقرات من ثلاث إلى واحدة في سيناريوهات العمل حسب الفئات.

**العمود الثالث: التنبؤ بالنفاد (Stockout Projection)**
تم تطوير لافتة تنبيه ديناميكية على شاشة البداية (ACCUEIL) تمسح ورقة الأصناف (ARTICLES) فوراً و تعرض حالة المخزون بنظام إشارات المرور: اللون الأخضر إذا كانت جميع الأصناف فوق نقطة إعادة الطلب، والأصفر إذا اقتربت بعض الأصناف من هذه النقطة، والأحمر إذا وصلت أصناف إلى حالة النفاد أو تحت مخزون الأمان. تُحدَّث اللافتة يدوياً عبر زر مخصص في لوحة القيادة، مما يمنح المسؤول رؤية لحظية لحالة المخزون دون الحاجة إلى تصفح أوراق العمل.

**العمود الرابع: البحث الضبابي (Fuzzy Search)**
تم تجهيز قائمة الأصناف في واجهة الإدخال بآلية بحث تلقائي أثناء الكتابة. يمكن للمستخدم كتابة نص جزئي (حرف أو أكثر) لتصفية القائمة حسب الكود أو التسمية بشكل غير حساس لحالة الأحرف. تُحفظ القائمة الأصلية الكاملة في الذاكرة عند أول ضغطة، وتُستعاد عند إجراء اختيار، مما يمنع تلف القائمة بشكل دائم. كما يُفعَّل القائمة المنسدلة تلقائياً عند إنتاج نتائج التصفية. هذه الآلية تقلل عدد النقرات المطلوبة للوصول إلى صنف محدد من 15 (تصفح القائمة كاملة) إلى 2-3 نقرات في أغلب السيناريوهات.

بهذا التصميم، يكتمل بناء النظام ليصبح أداة رقمية متكاملة تدمج بين دقة الرياضيات، وقوة البرمجة، وبساطة العرض، مما يحقق الهدف النهائي من الدراسة وهو "رقمنة التسيير اللوجيستي في القطاع التربوي". الكود المصدري الكامل للنظام متاح في المستودع الرسمي (Kamel, 2026).
...
*المصدر: إعداد الطالب --- ملاحظة ميدانية مباشرة + قياسات نظام ERP_Académie_v13.3 | فيفري--مارس 2026*
...
لم تكن هذه النتائج مجرد تقديرات نظرية، بل جاءت نتاج تطبيق تجريبي صارم. حيث تم إخضاع النظام لسلسلة من اختبارات التحقق الشاملة التي بلغت **144 فحصاً** موزعة على ثلاثة محاور: فحص سلامة البناء (112 فحصاً) يتحقق من تجميع الوحدات البرمجية وسلامة المراجع البينية، واختبارات تجريبية (16 اختباراً) تغطي كل السيناريوهات المحتملة من حسابات EOQ وROP وتصنيف ABC إلى إدخال البيانات والتنبيهات، وتدقيق نظام دعم القرار (16 فحصاً) في خمس مراحل: التكامل البنيوي، أمن البيانات، سلامة المعلومات، الدقة الحسابية، وصحة واجهة المستخدم. النجاح الكامل في هذه الفحوصات بدون استثناء يقدم دليلاً علمياً على متانة النظام وموثوقيته في بيئة العمل الحقيقية.
...
[^wils_ch2]: راجع: R. H. Wilson, "A Scientific Routine for Stock Control", *Harvard Business Review*, Vol. 13, N° 1, 1934, p. 120. وكذلك: F. W. Harris, "How Many Parts to Make at Once", *Factory, The Magazine of Management*, Vol. 10, N° 2, 1913, p. 136.
...
[^d789_method]: **منهجية حساب الطلب السنوي D=789:** تم احتساب الطلب السنوي بناءً على ملاحظة مباشرة لـ 38 يوم عمل في مصلحة المخازن (فبراير-مارس 2026). تم تسجيل جميع حركات الخروج (OUT) للصنف ART-001 (حبر الطابعة Toner G030) خلال هذه الفترة، ثم إسقاطها سنوياً通过ضرب المعدل اليومي في عدد أيام العمل السنوي (250 يوم). الطريقة: (إجمالي الخروج خلال 38 يوم ÷ 38) × 250 = الطلب السنوي. تجدر الإشارة إلى أن هذا المبلغ يمثل تقديرًا ميدانياً دقيقاً يعكس الاستهلاك الفعلي في ظل الظروف التشغيلية الحالية للمديرية، وهو ما يبرر استخدامه كمدخل أساسي لنموذج ويلسون. أما النظام (ERP) فيقوم بتحديث هذا المعامل تلقائياً بناءً على جميع الحركات المسجلة في سجل MOUVEMENTS، مما يضمن تكيف المعادلة مع أي تغير في أنماط الطلب.

[^cscmp_ch1]: راجع: M. C. Cooper, D. M. Lambert & J. D. Pagh, "Supply Chain Management: More Than a New Name for Logistics", *The International Journal of Logistics Management*, Vol. 8, N° 1, 1997, p. 1.

[^gscf_ch1]: راجع: S. Chopra & P. Meindl, *Supply Chain Management: Strategy, Planning, and Operation*, 7th ed., Pearson, 2019, p. 5.

[^lambert_ch1]: راجع: D. M. Lambert & J. R. Stock, *Strategic Logistics Management*, 3rd ed., Irwin, 1993, p. 412.

[^stock_ch1]: راجع: J. R. Stock & D. M. Lambert، المرجع السابق، ص. 421.

[^silver_ch1]: راجع: E. A. Silver, D. F. Pyke & D. J. Thomas, *Inventory and Production Management in Supply Chains*, 4th ed., Springer, 2017, p. 74. وكذلك: P. H. Zipkin, *Foundations of Inventory Management*, McGraw-Hill, 2000, p. 52.

[^belhadi_ch1]: راجع: M. E. A. Belhadi, *Modélisation et optimisation de la gestion de stocks des pièces de rechange : application SASACE-Algérie*, Mémoire PFE, École Nationale Polytechnique d'Alger, 2015, p. 34.

[^vanweele_ch1]: راجع: A. J. Van Weele, *Purchasing and Supply Chain Management*, 5th ed., Cengage Learning, 2010, p. 8.

[^vollmann_ch1]: راجع: T. E. Vollmann, W. L. Berry, D. C. Whybark & F. R. Jacobs, *Manufacturing Planning and Control for Supply Chain Management*, 5th ed., McGraw-Hill, 2005, p. 3.

[^decree15_ch2]: راجع: الجمهورية الجزائرية الديمقراطية الشعبية، المرسوم الرئاسي رقم 15-247 المؤرخ في 16 سبتمبر 2015 المتعلق بتنظيم الصفقات العمومية وتسييرها، *الجريدة الرسمية*، العدد 50، 2015.

[^decree20_ch2]: راجع: الجمهورية الجزائرية الديمقراطية الشعبية، المرسوم التنفيذي رقم 20-270 المتعلق بتنظيم الميزانية والمحاسبة العمومية، *الجريدة الرسمية*، 2020.

[^circular23_ch2]: راجع: وزارة المالية ووزارة التربية الوطنية، المنشور الوزاري المشترك المتعلق بتسيير المستودعات في المؤسسات التربوية، وثيقة داخلية، 2023.

[^sebti_ch3]: راجع: A. Sebti, *Élaboration d'un outil d'aide à la décision pour la gestion des stocks basé sur l'étude prévisionnelle*, Mémoire PFE, École Nationale Polytechnique d'Alger, 1993, p. 12.

[^yahi_ch3]: راجع: A. Yahi, *Élaboration d'un logiciel de gestion de stocks de pièces de rechange*, Mémoire PFE, École Nationale Polytechnique d'Alger, 1992, p. 8.

[^bouchahlata_ch3]: راجع: M. Bouchahlata, *Contribution à l'amélioration du lead time de la chaîne logistique en combinant une solution VBA et la business intelligence : application Ericsson Algérie*, Mémoire PFE, École Nationale Polytechnique d'Alger, 2021, p. 45.

[^msft_vba_ch3]: راجع: Microsoft Corporation, *VBA Reference — Visual Basic for Applications*, Microsoft Docs, 2023.

[^msft_excel_ch3]: راجع: Microsoft Corporation, *Excel Object Model Overview*, Microsoft Docs, 2019.
...
56. **Kamel, M.** (2026). ERP_Académie v13.3 --- Système d'Aide à la Décision pour la Gestion des Stocks. *GitHub*. https://github.com/kamelmh/lsm-vba-core.
...
وصف موجز لأوراق العمل الرئيسية في ملف Excel (26 ورقة عمل مجموعها):

| ورقة العمل | الوظيفة |
| :--- | :--- |
| ACCUEIL | شاشة الانطلاق ومركز القيادة |
| ARTICLES | قاعدة البيانات المركزية للأصناف (15 صنفاً) |
| MOUVEMENTS | سجل الحركات الرقمي (Audit Trail) |
| TABLEAU DE BORD | لوحة القيادة الاستراتيجية ومؤشرات الأداء |
| ALERTE_DASHBOARD | لوحة التنبيهات والتنبؤ بالنفاد |
| INVENTAIRE | جرد المخزون الفعلي |
| RAPPORTS | التقارير الإدارية المولَّدة آلياً |
| CALCULS_EOQ | حسابات ويلسون EOQ وROP وSS |
| FOURNISSEURS | قاعدة بيانات الموردين وتقييمهم |
| BON_RECEPTION | وصل استلام البضاعة (BR) |
| BON_SORTIE | إذن صرف البضاعة (BS) |
| BON_COMMANDE | أمر الشراء (BC) |
| DA_DEMANDE_ACHAT | طلب الشراء الداخلي (DA) |
| AUDIT_LOG | سجل المراجعة غير القابل للتعديل |
| SYS_STRINGS | نصوص النظام متعددة اللغات |
|_guide | دليل المستخدم التفاعلي |
| + 10 أوراق أخرى | System_Lists, CONVENTIONS, HISTORIQUE, DASHBOARD, FORM_INPUT, BORDEREAU_COMMANDE, STAGING_BUFFER, RECEIPT_TAG, TEMPLATE_BON, VBA_MODULES |
## الملحق الثاني: وحدات VBA الرئيسية
الوحدات البرمجية المطوَّرة (42 وحدة + نموذج واحد، إجمالي 17,700 سطر):

| الوحدة | الوظيفة |
| :--- | :--- |
| **mod_StockEngine** | حسابات EOQ، ROP، CMUP |
| **mod_StockEntry_Logic** | منطق إدخال الحركات + تصنيف تلقائي + بحث ضبابي |
| **mod_Reports** | هندسة الطباعة + توليد التقارير (ConfigurerImpression) |
| **mod_UI_Setup** | بناء الواجهة + لافتة التنبيه بالنفاد (DrawStockoutBanner) |
| **mod_DemoData** | توليد البيانات التجريبية + إعداد الطباعة الصامت |
| **mod_Dashboard** | لوحة المراقبة والتنبيهات |
| **mod_ExportEngine** | تصدير التقارير بصيغ PDF وCSV |
| **mod_TransactionSafety** | أمان المعاملات (ACID) ومنع التعديل اليدوي |
| **mod_DataValidator** | التحقق من صحة البيانات عند الإدخال |
| **mod_AuditTrail** | سجل المراجعة غير القابل للتعديل |
...
| **mod_UIEnhancements** | تحسينات واجهة المستخدم (Segoe UI) |
| **mod_ThemingEngine** | محرك الألوان والسمات البصرية |
| **frmStockEntry** | نموذج إدخال الحركات (بحث ضبابي + تشفير عشري) |
| + 26 وحدة أخرى | mod_Forecasting, mod_Barcode, mod_Budget, mod_Procurement, mod_Localization, mod_LibreBridge, mod_TaskOrchestrator, mod_CSVImportExport, mod_SupplierRegistry, mod_SupplierScorecard, mod_BarcodeSim, mod_QRCode, mod_ReceiptTag, mod_StockAging, mod_StockOutPredictor, mod_ObsidianExporter, mod_PCControl, mod_Profiler, mod_InventoryReconciliation, mod_SharedEnvironment, mod_BudgetSetup, mod_Analysis, mod_Navigation, mod_Database, mod_Timer, MAIN_MACROS |
