...
- **هذه هي الصيغة النهائية لنموذج ويلسون، وهي تُمثّل كمية الطلب التي تُحقّق التوازن الأمثل بين تكاليف الإصدار وتكاليف الاحتفاظ. تطبيق على بيانات المشروع الحقيقية: بفرض الطلب السنوي D = 789 وحدة (Toner G030 - ART-001)، وتكلفة الطلب S = 801.45 دج (مُستخرجة من تحليل التكاليف الفعلية في الميدان)، وسعر الوحدة PU = 4,500 دج، ومعدل الاحتفاظ I = 20%:**

- تكون التكلفة الإجمالية الدنيا عند هذه الكمية:

- **نلاحظ أن التكلفة الإجمالية تتوزع بالتساوي بين تكاليف الطلب (7,040 دج) وتكاليف الاحتفاظ (7,040 دج)، وهذه سمة الرياضيات المثلى: عند Q* يتساوى حدّي التكلفة. العدد الأمثل للطلبيات سنوياً:**
...
**نقطة إعادة الطلب = (الاستهلاك اليومي × أجل التسليم) + مخزون الأمان** تطبيق (بناءً على بيانات المشروع الحقيقية): بفرض استهلاك يومي قدره 3.156 وحدة (= D/250 = 789/250)، وأجل تسليم (LT) قدره 2 يوم، ومخزون أمان (SS) قدره 200 وحدة: ROP = (3.156 × 2) + 200 = 206 وحدة**
...
| --- | --- | --- |
| الطلب السنوي (D) | 789 وحدة | جرد فعلي + إسقاط سنوي |
| تكلفة إصدار الطلبية (S) | 801.45 دج | تحليل التكاليف الإدارية الفعلية |
| سعر الوحدة (PU) | 4,500 دج | فاتورة ENAP الجزائر |
...
التكلفة الإجمالية عند الكمية المثلى Q* = 37:
...
**جدول رقم 01: المؤشرات الكمية المثالية للأصناف الاستراتيجية**
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| ART-001 Toner G030 | 789 | 801.45 | 4,500 | 20% | 37 | 206 | 200 |
...
- **تباين الاحتياجات: التباين بين احتياجات الصنف AX (Toner G030) الذي يتطلب رقابة يومية ومخزون أمان مرتفع (200 وحدة)، والصنف CZ (الدباسة) الذي يكفي فيه مخزون أمان ضئيل (10 وحدات).**
...
**جدول رقم 02: تحليل الفجوة التشغيلية بين التسيير اليدوي ونظام دعم القرار**
...
**خلاصة الفصل الثاني**
كشف هذا الفصل عن الهوَّة القائمة بين ما تستوجبه النماذج الرياضية من دقة كمية (37 وحدة، ROP = 206، CMUP ديناميكي) وبين ما يُنتجه الواقع اليدوي من تقدير ذاتي معرَّض للخطأ. وقد تبيَّن أن المشكلة ليست في غياب الكفاءة البشرية، بل في غياب الأداة التقنية القادرة على ترجمة هذه المعادلات إلى قرارات آنية مُؤتمَتة. ينتقل الفصل الثالث من هذا التشخيص إلى الحل: تصميم نظام دعم القرار v13.3 وإنجازه.
...
**لقياس أثر النظام على أداء مصلحة المخازن، جرت مقارنة كمية بين المؤشرات التشغيلية المُرصَدة قبل التطبيق (المرحلة اليدوية) وبعده (مرحلة نظام ERP). تُعرض النتائج في الجدول أدناه: الجدول رقم 03: مقارنة مؤشرات الأداء اللوجستي قبل وبعد تطبيق نظام دعم القرار**
...
**الجدول رقم 04: --- نتائج التحقق من فرضيتَي البحث --- الدليل الميداني**
...
**الجدول رقم 06: --- التوصيات المقدَّمة لمديرية التربية لولاية البيض**
...
| --- | --- | --- | --- | --- |
| ART-001 | Toner G030 | 289 | 206 | AX |
| ART-002 | Ramette A4 80g | 520 | 69.6 | AX |
...
| --- | --- | --- |
| EOQ / Q* | mod_StockEngine | حساب الكمية الاقتصادية بـ 37 وحدة |
| ROP | mod_StockEngine | حساب نقطة إعادة الطلب بـ 206 وحدة |
...
| الطلب السنوي | D = 789 وحدة (ملاحظة 38 يوماً) | مقاس ميدانياً |
