# CCA'2026 Submission — Ready to Paste
...
- Kamel Abdelghani | CNEPD | Algeria

## Subject Area:
Track 2: Artificial Intelligence and Cybersecurity
(The DSS uses AI-like classification algorithms and decision automation)

## File to upload:
output/English_Research_Paper_CCA2026.pdf (158 KB, blind version)

## Checklist before Submit:
- [x] Title pasted
- [x] Abstract pasted (1251/2000 chars)
- [x] Author info correct
- [ ] Subject area selected (Track 2)
- [ ] PDF uploaded
- [ ] Click Submit
