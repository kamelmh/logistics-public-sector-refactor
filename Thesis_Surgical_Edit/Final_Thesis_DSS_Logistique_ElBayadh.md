...
تُمثّل المستودعات العصب الحيوي في أي منظومة لوجيستية، حيث لا تقتصر وظيفتها على مجرد الاحتفاظ بالسلع، بل تمتد لتشمل أربع وظائف استراتيجية على الأقل وفقاً لـ Lambert & Stock (1993):
...
**الجدول رقم (05) --- مقارنة مؤشرات الأداء اللوجستي قبل وبعد تطبيق نظام دعم القرار**
...
1. **Wilson, R. H.** (1934). A Scientific Routine for Stock Control. *Harvard Business Review*, 13(1), 116--128.
2. **Silver, E. A., Pyke, D. F., & Thomas, D. J.** (2017). *Inventory and Production Management in Supply Chains* (4th ed.). Springer.
3. **Zipkin, P. H.** (2000). *Foundations of Inventory Management*. McGraw-Hill.
4. **Vollmann, T. E., Berry, W. L., Whybark, D. C., & Jacobs, F. R.** (2005). *Manufacturing Planning and Control for Supply Chain Management* (5th ed.). McGraw-Hill.
5. **Chopra, S., & Meindl, P.** (2019). *Supply Chain Management: Strategy, Planning, and Operation* (7th ed.). Pearson.

## ثانياً: المحاضرات والمقررات الدراسية --- BTS GSL (TAG1801)

6. **تحديد وجمع المعلومات الداخلية والخارجية (Identification et Collecte des Informations Internes et Externes).** (2024). مقياس BTS GSL، الفصل الدراسي الأول.
7. **دراسة الأسعار وشروط التفاوض (Études des Prix et les Conditions de Négociation).** (2024). مقياس BTS GSL، الفصل الدراسي الأول.
8. **تسجيل ومراقبة التوريدات (Enregistrement Comptable et Contrôle des Approvisionnements).** (2024). مقياس BTS GSL، الفصل الدراسي الثالث.
9. **إجراء الجرد الفعلي (Réalisation de l'Inventaire Physique).** (2024). مقياس BTS GSL، الفصل الدراسي الثالث.
10. **تحديد الاحتياجات وعناصر برنامج التوريد (Détermination des Besoins et les Éléments Constitutifs du Programme d'Approvisionnement).** (2024). مقياس BTS GSL، الفصل الدراسي الثالث.
11. **الإدارة الفعالة للتوريدات (Gestion Efficace des Approvisionnements).** (2024). مقياس BTS GSL، الفصل الدراسي الثالث.
12. **التخطيط الاستراتيجي للوجستيك (Planification Stratégique de la Logistique).** (2024). مقياس BTS GSL، الفصل الدراسي الرابع.
13. **تجديد الأمر (Renouvellement de la Commande).** (2024). مقياس BTS GSL، الفصل الدراسي الرابع.
14. **المتابعة والتحكم في المواد المسلَّمة (Suivi et Contrôle des Articles Livrés).** (2024). مقياس BTS GSL، الفصل الدراسي الرابع.
15. **الرياضيات العامة (Mathématiques Générales).** (2024). مقياس BTS GSL، الفصل الدراسي الأول.
16. **الإحصاء الوصفي (Statistiques Descriptives).** (2024). مقياس BTS GSL، الفصل الدراسي الثالث.
17. **الحساب التجاري (Arithmétique Commerciale).** (2024). مقياس BTS GSL، الفصل الدراسي الثاني.
18. **تقنيات التعبير والتواصل (Techniques d'Expression et de Communication).** (2024). مقياس BTS GSL، الفصل الدراسي الثالث.

## ثالثاً: الوثائق الرسمية والنصوص التنظيمية

19. **وزارة التربية الوطنية، الجمهورية الجزائرية الديمقراطية الشعبية.** (2020). المنهاج الدراسي لشهادة التقني السامي في تسيير المخزونات واللوجستيك --- TAG1801. الديوان الوطني للامتحانات والمسابقات.
20. **مديرية التربية لولاية البيض.** (2025). السجلات السنوية لحركة المخزون --- مصلحة المخازن. وثائق داخلية غير منشورة.

## رابعاً: المصادر الإلكترونية

21. **Microsoft Corporation.** (2023). VBA Reference --- Visual Basic for Applications. *Microsoft Docs*. https://docs.microsoft.com/en-us/office/vba/api/overview/
22. **Microsoft Corporation.** (2019). Excel Object Model Overview. *Microsoft Docs*. https://docs.microsoft.com/en-us/office/vba/api/excel/overview
23. **Kamel, M.** (2026). ERP_Academie_v5 --- Système d'Aide à la Décision pour la Gestion des Stocks. *GitHub*. https://github.com/kamelmh/lsm-vba-core
