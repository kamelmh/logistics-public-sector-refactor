...
def run_audit(docx_path):
    ...
    checks = {
        ...
        'eoq': 'Q*' in all_text or 'EOQ' in all_text or '\u0643\u0645\u064a\u0629 \u0627\u0642\u062a\u0635\u0627\u062f\u064a\u0629' in all_text,
        'rop': 'ROP' in all_text or ('\u0646\u0642\u0637\u0629 \u0625\u0639\u0627\u062f\u0629 \u0627\u0644\u0637\u0644\u0628' in all_text),
        'safety_stock': 'stock de s\u00e9curit\u00e9' in all_text.lower() or 'safety stock' in all_text.lower() or '\u0645\u062e\u0632\u0648\u0646 \u0627\u0644\u0623\u0645\u0627\u0646' in all_text,
