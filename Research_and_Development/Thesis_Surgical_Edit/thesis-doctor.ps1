...
function Invoke-FixCmd {
    ...
    try {
        switch -Wildcard ($FixCommand) {
            ...
            "fix:all" {
                Invoke-FixCmd "fix:font"; Invoke-FixCmd "fix:margins"
                Invoke-FixCmd "fix:rtl"; Invoke-FixCmd "fix:spacing"
                Invoke-FixCmd "fix:headings"; Invoke-FixCmd "fix:tables"
                Invoke-FixCmd "fix:toc"; Invoke-FixCmd "fix:footers"
