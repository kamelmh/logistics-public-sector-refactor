...
'   NIF  - Numro d'Identification Fiscale (15 digits)
'   NIS  - Numro d'Identification Statistique (13 digits)
...
Public Type SupplierInfo
    ...
    NIF             As String       ' Numro d'Identification Fiscale (15 digits)
    NIS             As String       ' Numro d'Identification Statistique (13 digits)
...
Public Function GetSupplierInfo(ByVal supplierCode As String) As SupplierInfo
    ...
    Select Case UCase(Trim(supplierCode))
        Case "F-001"
            ...
            s.Address = "Rue des Frres Abdeslam, Bab Ezzouar, Alger 16000"
            s.Phone = "023 00 00 01"
            s.NIF = "000116010002500"
            s.NIS = "0161600100250"
            s.RC = "16/00-0012345B67"
            s.ArticleImpot = "250"
            s.Category = "Fournitures pdagogiques"
            s.IsActive = True
            s.Rating = 4.2
        ...
        Case "F-003"
            s.Code = "F-003"
            s.Name = "Bureau Plus SPA - Chane nationale"
