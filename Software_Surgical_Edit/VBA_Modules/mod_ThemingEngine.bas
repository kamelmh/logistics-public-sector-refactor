...
Public Sub ApplyTheme(ByRef frm As Object)
    ...
    '-- Buttons
    Call ApplyButtonPrimaryTheme(frm, "btnEnregistrer")   ' Primary action
...
'-- Primary button (Enregistrer) - blue, filled, white text
Public Sub ApplyButtonPrimaryTheme(ByRef frm As Object, ByVal ctrlName As String)
    ...
    ctrl.ControlTipText = "Enregistrer la transaction (Enter)"
End Sub
...
Public Sub EnableButtonHover(ByRef frm As Object)
    ...
    '   Private Sub btnEnregistrer_MouseMove(...)
    '       HoverHighlight Me.btnEnregistrer, CLR_PRIMARY_LIGHT, vbWhite
    '   End Sub
    ...
    hoverMap = Array( _
        Array("btnEnregistrer", RGB(0, 102, 204), RGB(255, 255, 255)), _
