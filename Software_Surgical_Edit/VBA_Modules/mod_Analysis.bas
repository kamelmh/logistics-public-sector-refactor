...
Public Sub UpdateABC_Classification()
    ...
    MsgBox "La classification ABC-XYZ a t mise a jour avec succes a partir des donnees de consommation.", vbInformation, "Analyse Complete"
    Exit Sub

ErrorHandler:
    MsgBox "Une erreur s'est produite durant l'analyse: " & Err.Description, vbCritical, "ERP Acadmie v13"
...
ErrorHandler:
    MsgBox "Une erreur s'est produite durant l'analyse de rupture: " & Err.Description, vbCritical, "ERP Acadmie v13"
...
ErrorHandler:
    MsgBox "Une erreur s'est produite durant le recalcul des prvisions: " & Err.Description, vbCritical, "ERP Acadmie v13"
...
ErrorHandler:
    MsgBox "Une erreur s'est produite durant l'analyse de vieillissement: " & Err.Description, vbCritical, "ERP Acadmie v13"
...
Public Sub RunFullAnalysis()
    ...
    MsgBox "Analyse complete: CMUP, ABC-XYZ, prvisions et rupture de stock mis a jour.", vbInformation, "ERP Acadmie v13"
    Exit Sub
...
ErrorHandler:
    ...
    Application.Calculation = xlCalculationAutomatic
    Application.EnableEvents = True
    MsgBox "Une erreur s'est produite durant l'analyse complete: " & Err.Description, vbCritical, "ERP Acadmie v13"
