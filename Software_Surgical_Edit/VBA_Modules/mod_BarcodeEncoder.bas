...
Private Sub InitCode128()
    ...
    m_C128Patterns(102) = "411131": m_C128Patterns(103) = "211412"
    m_C128Patterns(104) = "211214": m_C128Patterns(105) = "211232"
...
Public Function EAN13_ParityTable(ByVal firstDigit As Integer) As String
...
Public Function EAN13_LeftPattern(ByVal digit As Integer) As String
...
Public Function EAN13_RightPattern(ByVal digit As Integer) As String
...
Public Function Interleaved2of5_Encode(ByVal data As String) As String
