...
Public Sub AjouterMouvement()
    ...
    Else
        MsgBox "Erreur: Le formulaire '" & frmName & "' n'existe pas." & vbCrLf & _
               "Veuillez vrifier que le fichier n'est pas corrompu.", _
               vbCritical, "ERP Acadmie v13.2"
    End If
    Exit Sub
...
Public Sub ShowMainMenu()
    ...
    If Not ws Is Nothing Then
        ws.Activate
    Else
        MsgBox "Erreur: Feuille d'accueil introuvable.", vbCritical, "ERP Acadmie v13.2"
    End If
    Exit Sub

ErrorHandler:
    MsgBox "Erreur: " & Err.Description, vbCritical, "ERP Acadmie v13.2"
End Sub
