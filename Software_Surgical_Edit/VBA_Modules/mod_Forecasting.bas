...
Public Sub RefreshForecastSheet()
    ...
    headers = Array("Code Article", "Description", "Stock Actuel", _
                    ...
                    "Demande Projete (30j)", "Couverture (Jours)", _
...
' Referenced by MAIN_MACROS ("RUN-FORECAST") as runtime Application.Run callback.
' Delegates to CalculateAllForecasts (closest "run forecast for all articles" equivalent).
' ================================================================================
Public Sub RunForecast()
    Dim results() As ForecastResult
    Call CalculateAllForecasts(results)
End Sub
