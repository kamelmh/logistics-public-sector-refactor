...
' Article-specific safety stocks ? mirrors Unite de traitement VBA GROUND_TRUTH (Calibrated v13.4 from v7 historical)
Public Function GetSafetyStock(ByVal sku As String) As Double
    Select Case UCase(Trim(sku))
        ...
        Case "ART-004": GetSafetyStock = 20   ' Boite archives (v7 Stock Min)
        ...
        Case "ART-015": GetSafetyStock = 39   ' Toner generique (v7 Stock Min)
...
Public Function GetArticles(ByVal filterCat As String) As Collection
    ...
    If wsArt Is Nothing Then
        articles.Add "ART-001 | Papier A4 80g/m2"
        articles.Add "ART-002 | Toner G030 (noir)"
        articles.Add "ART-003 | Papier A3 80g/m2"
        articles.Add "ART-004 | Boite archives carton"
        articles.Add "ART-005 | Agrafeuse de bureau"
        articles.Add "ART-006 | Stylos bille boite/50"
        articles.Add "ART-007 | Registre grand format 5m"
        articles.Add "ART-008 | Encre tampon"
        articles.Add "ART-009 | Sous-chemise carton"
        articles.Add "ART-010 | Chemise cartonnee"
        ...
        articles.Add "ART-014 | Classeur a levier"
        articles.Add "ART-015 | Cartouche toner generique"
