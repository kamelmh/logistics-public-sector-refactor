...
Public Sub GenerateOrderReport()
    ...
    If lastRow < 2 Then
        MsgBox "Aucun article trouv dans le catalogue.", vbExclamation, "ACADEMIX v13"
        Exit Sub
    End If
...
NextArticle:
    ...
    Else
        MsgBox "Aucun article ne ncessite de rapprovisionnement.", vbInformation, "ACADEMIX v13"
    End If
    
    MsgBox "Bordereau de commande gnr avec succs !", vbInformation, "ACADEMIX v13"
End Sub
