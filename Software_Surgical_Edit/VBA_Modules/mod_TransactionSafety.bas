...
Public Sub CheckCrashRecovery()
    ...
    If pendingFlag = "PENDING" Then
        ...
        response = MsgBox("Une transaction incomplte a t dtecte:" & vbCrLf & _
                         "Doc: " & docRef & vbCrLf & vbCrLf & _
                         "Voulez-vous annuler cette transaction?", _
                         vbYesNo + vbExclamation, "Rcupration aprs crash")
        ...
        If response = vbYes Then
            ...
            If Len(snapshotData) > 0 Then
                ...
                If IsArray(recoveredSnapshot) Then
                    ...
                    MsgBox "Transaction annule avec succs." & vbCrLf & _
                           "Les stocks ont t restaurs  leur tat d'avant la transaction.", _
                           vbInformation, "Rcupration russie"
                Else
                    ...
                    MsgBox "Impossible de restaurer la transaction." & vbCrLf & _
                           "Les donnes de sauvegarde sont corrompues.", _
                           vbCritical, "Erreur de rcupration"
                End If
            Else
