...
Public Sub CheckCrashRecovery()
    ...
    If pendingFlag = "PENDING" Then
        ...
        response = MsgBox("Une transaction incompl�te a �t� d�tect�e:" & vbCrLf & _
                         "Doc: " & docRef & vbCrLf & vbCrLf & _
                         "Voulez-vous annuler cette transaction?", _
                         vbYesNo + vbExclamation, "R�cup�ration apr�s crash")
        ...
        If response = vbYes Then
            ...
            If Len(snapshotData) > 0 Then
                ...
                If IsArray(recoveredSnapshot) Then
                    ...
                    MsgBox "Transaction annul�e avec succ�s." & vbCrLf & _
                           "Les stocks ont �t� restaur�s � leur �tat d'avant la transaction.", _
                           vbInformation, "R�cup�ration r�ussie"
                Else
                    ...
                    MsgBox "Impossible de restaurer la transaction." & vbCrLf & _
                           "Les donn�es de sauvegarde sont corrompues.", _
                           vbCritical, "Erreur de r�cup�ration"
                End If
            Else
