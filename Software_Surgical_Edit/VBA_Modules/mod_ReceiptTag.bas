...
' ============================================================
' ERP Academie El Bayadh  Smart Receipt Tag Generator
...
Public Sub GenerateReceiptTagPDF()
    ...
    verifyCode = GenerateLocalVerifyCode(receiptID, mvtDate, artCode, qty, mvtType)
...
Public Sub SetupReceiptTagSheet()
    ...
    With ws
        ...
        ' Header
        .Range("A1:F1").Merge
        .Range("A1").Value = "MAGASIN MDIDRIYA TARBIYA EL BAYADH  /  ???? ???????? ?????"
...
' ============================================================
' Generate Local Verification Code (Offline-First)
' Creates a deterministic code from receipt data for audit
' and manual verification without internet connectivity.
' Format: V-XXXX-XXXX-XXXX (12 alphanumeric chars)
' ============================================================
